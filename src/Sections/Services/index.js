...
const Services = () => {
	...
	return (
		<ServiceSection id="services">
			<Background ref={ref}>
				<Title className="title">私たちについて</Title>
				<Line id="line" />
			...
			<Content ref={addToRefs}>
				<TextBlock
					topic="Design"
					title={<h1>私たちは最適なデザインを提供します</h1>}
					subText={<h5>We help clients to build great design</h5>}
				/>
				<OBJ>
			...
			<Content ref={addToRefs}>
				<TextBlock
					topic="Develop"
					title={<h1>私たちは高品質なWeb & Appを開発します</h1>}
					subText={
						<h5>
			...
			<Content>
				<TextBlock
					topic="Support"
					title={<h1>私たちは公開後のサポートも行います</h1>}
					subText={<h5>We also provide post-publication support</h5>}
				/>
				<OBJ>
